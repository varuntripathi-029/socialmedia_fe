...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Standard signup requires username, let's pass it to choose-username
        sessionStorage.setItem('pendingSignup', JSON.stringify({ fullName, email, password, type: 'email' }));
        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary/5 via-white to-primary/10 px-4">
            <div className="w-full max-w-md">
                <div className="mb-8 text-center">
                    ...
                    <p className="mt-2 text-muted-foreground">Create your account and start connecting.</p>
                </div>
                ...
                <div className="rounded-2xl border bg-card p-8 shadow-lg">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="fullName" placeholder="Your name" value={fullName} onChange={(e) => setFullName(e.target.value)} required className="rounded-xl" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="confirmPassword" type="password" placeholder="••••••••" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required className="rounded-xl" />
                        </div>
